...
public class PushListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        mExpandableListView = (ExpandableListView)findViewById(R.id.push_lvExp);

        //This will eventually call a new activity presenting the full detail of the PushItem.
